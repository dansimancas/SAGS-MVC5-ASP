...
namespace SAGS.Controllers
{
    public class TeensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Lastname,Gender,Address,City,Document,Identification")] Teen teen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Lastname,Gender,Address,City,Document,Identification")] Teen teen)
        {
            if (ModelState.IsValid)
            {
